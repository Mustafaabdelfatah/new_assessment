...
<body id="kt_app_body" data-kt-app-page-loading-enabled="true" data-kt-app-page-loading="on"
            ...
            <div class="app-wrapper  d-flex " id="kt_app_wrapper">
                ...
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content" style="padding-top: 5px !important">
    ...
    {{-- <script src="{{ asset('assets/js/wizard/create-app.js')}}"></script> --}}
...
<body id="kt_app_body" data-kt-app-page-loading-enabled="true" data-kt-app-page-loading="on"
      ...
      data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true"
      data-kt-app-toolbar-enabled="true" class="app-default">
 @include('includes.partials.theme-mode._init')
{{-- @include('includes.layouts.partials._page-loader')
@include('includes.layouts.partials._default')
@include('includes.layouts.partials._default') --}}
...
<script>
     $("#load-more").click(function() {
            var current_users_count = $("#child_users").children().length;
            $.ajax({
                type: "POST",
                url: "{{ route('admin.show.users') }}",
                data: { current_users_count: current_users_count },
                success: function(response) {
                    $("#child_users").append(response.users);
