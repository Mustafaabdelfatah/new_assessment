                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                            <form method="POST" action="{{ route('admin.password.email') }}">
                                @csrf
                                <div class="form-group col-md-12 " style="margin:20px auto">
                                    <label for="input-field1">Email</label>
                                    <input type="text"  class="form-control" name="email" @error('email') is-invalid @enderror value="{{ old('email') }}" required autocomplete="email" autofocus>
                                    @error('email')
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12   d-flex">
                                        <a href="{{url('/login')}}" title="To login" style="width: 30px;background:#ecffd8;text-align:center;margin-right:4px;border-radius:3px; height:100%;line-height:35px"><i class="fas fa-chevron-left"></i></a>
                                        <button type="submit" class="btn btn-light-primary" style="font-size: 12px">
