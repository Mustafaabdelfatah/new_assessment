    ...
    <div class="card-body pt-9 pb-0">
       ...
       <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
          ...
          <div class="d-flex flex-center flex-shrink-0 bg-light rounded w-100px h-100px w-lg-150px h-lg-150px me-7 mb-4">
             <img class="mw-50px mw-lg-75px" src="{{asset('icons/assessment.webp')}}" alt="image">
          </div>
          <!--end::Image-->
          <!--begin::Wrapper-->
            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
               ...
               <div class="d-flex flex-column">
                  ...
                  <div class="d-flex align-items-center mb-1">
                     <a href="#" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">{{$assessment->title}}</a>
                     <span class="badge badge-light-success me-auto">{{$assessment->status}}</span>
                  </div>
                  <!--end::Status-->
               </div>
               <!--end::Details-->
               ...
               <div class="d-flex mb-4">
                  <a href="#" data-route="{{route('admin.renderAssessmentByQuestion',$assessment->id)}}" data-assessment_id="{{$assessment->id}}" class=" btn btn-sm btn-primary assessment_question ">Asessment Question</a>
                  <!--begin::Menu-->
                  <div class="me-0">
                     <!--begin::Menu 3-->
               ...
               <div class="d-flex flex-wrap">
                  ...
                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                     ...
                     <div class="d-flex align-items-center">
                        <div class="fs-4 fw-bold">{{$assessment->start_date->format('d-m-y')}}</div>
                     </div>
                     <!--end::Number-->
                     <!--begin::Label-->
                  ...
                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                     ...
                     <div class="d-flex align-items-center">
                        ...
                        <div class="fs-4 fw-bold counted" data-kt-countup="true" data-kt-countup-value="{{$assessment->users_count}}" data-kt-initialized="1">{{$assessment->users_count}}</div>
                     </div>
                     <!--end::Number-->
                     <!--begin::Label-->
                  ...
                  <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                     ...
                     <div class="d-flex align-items-center">
                        ...
                        <div class="fs-4 fw-bold counted" data-kt-countup="true" data-kt-countup-value="{{$assessment->questions_count}}"   data-kt-initialized="1">{{$assessment->questions_count}}</div>
                     </div>
                     <!--end::Number-->
                     <!--begin::Label-->
                ...
                @endphp
                 <div class="col-md-6 col-xxl-4">
                    ...
                    <div class="card ">
                           ...
                           @endif
                            ...
                            <div class="card-title m-0">
                               ...
                               <div class="symbol symbol-50px w-50px bg-light">
                                ...
                                <button type="button" class=" rate_assessment badge badge-primary fw-bold me-auto px-4 py-3"
                        ...
                        <!--end::Name-->
                        <!--begin::Position-->
                        <div class="fw-semibold text-gray-400 mb-6">{{$user->position->title}}</div>
                        <!--end::Position-->
                        <!--begin::Info-->
                        <div class="d-flex flex-center flex-wrap">
                            <!--begin::Stats-->
                            <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                <div class="fs-6 fw-bold text-gray-700">{{ $rate?->rate   }} %</div>
                                <div class="fw-semibold text-gray-400">Rate</div>
                            </div>
                            <!--end::Stats-->
                            <!--begin::Stats-->
                            <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                <div class="fs-6 fw-bold text-gray-700">{{$assessment->start_date->format('y-m-d')}}</div>
                                <div class="fw-semibold text-gray-400">Date</div>
                            </div>
                            <!--end::Stats-->
                            <!--begin::Stats-->
                            <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                <div class="fs-6 fw-bold text-gray-700">{{$assessment?->manager?->name}}</div>
