                    ...
                    <tr id="row-{{ $assessment->id }}">
                        ...
                        <td class="status" data-field="status">
                            @isset($assessment)
                                ...
                                @if($today->gt($assessmentDate) && $assessment->status== 'active')
                        ...
                        <td class="text-end">
                            ...
                            <a href="{{ url('assessment/show/' . $assessment->id .'/'. $assessment->title) }}"
                               class="btn btn-icon assign-button btn-active-light-primary w-30px h-30px">
                            ...
                            @if ($check_assessment_publish)
                                <button
                                    class="btn btn-icon assign-button btn-active-light-primary assign-question-button w-30px h-30px"
                                    data-id="{{$assessment->id}}"
                                    title="Assign Question">
                                    <img src="{{asset('icons/question-mark.png')}}" class="action_icon"
                                         style="height:20px" alt="">
                                </button>
                            @endif
                            <button id="edit-button-{{ $assessment->id }}"
                                    class="btn btn-icon edit-record btn-active-light-primary w-30px h-30px  "
                ...
                <div class="col-md-6 col-xl-4">
                    ...
                    <div class="card border-hover-primary ">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                ...
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <span class="badge badge-light-primary fw-bold me-auto px-4 py-3"
                                          style="text-transform: capitalize">{{$assessment->status}}</span>
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                            ...
                            <div class="card-toolbar">
                                <a href="{{ url('assessment/show/' .$assessment->id. '/'. $assessment->title) }}"
                                   class="badge badge-primary fw-bold me-auto px-4 py-3">Make Rate</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        <!--end:: Card header-->
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="h-4px w-100 bg-light mb-5" data-bs-toggle="tooltip"
                                ...
                                <div class="bg-primary rounded h-4px" role="progressbar"
                                     style="width: {{$assessment->percentage_rated}}%" aria-valuenow=" 50"
