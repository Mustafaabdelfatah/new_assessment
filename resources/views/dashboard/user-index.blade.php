                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $user_data->name }}</a>
                            <a href="#">
                                {{--
                ...
                <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                        ...
                        <div class="fw-bold text-danger me-2">
                            <a href="{{ route('admin.rate.details', ['assessment' => $firstQuarter->title,   'startdate' => 'January 1', 'enddate' => 'March 31', 'userid' => $userId]) }}" class="btn btn-primary btn-sm">Rate Details</a>
                        </div>
                        <!--end::Number-->
                    </div>
                    <!--end::Stats-->
