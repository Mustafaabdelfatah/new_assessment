                ...
                <div class="card h-100">
                    ...
                    <div class="card-header flex-nowrap border-0 pt-9">
                        ...
                        <div class="card-title m-0">
                            <span
                                class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0"> Avg Rate In {{$firstQuarter->title}} </span>
                            <!--end::Title-->
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                    ...
                    <div class="card-body d-flex flex-column px-9 pt-6 pb-8">
                        ...
                        <div class="d-flex align-items-center flex-wrap mb-5 mt-auto fs-6">
                            ...
                            <div class="fw-bold text-danger me-2">
                                <a href="{{ route('admin.rate.details', ['assessment' => $firstQuarter->title,   'startdate' => 'January 1', 'enddate' => 'March 31', 'userid' => $userId]) }}"
