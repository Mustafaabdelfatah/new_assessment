...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
    ...
    <div class="d-flex flex-column bgi-no-repeat rounded-top"
        ...
        <h3 class="text-white fw-semibold px-9 mt-10 mb-6">
            Notifications <span class="fs-8 opacity-75 ps-3">{{ auth()->user()->notifications()->count() }}</span>
        </h3>
        <!--end::Title-->
        <!--begin::Tabs-->
                ...
                <div class="scroll-y mh-325px my-5 px-8">
                    @foreach (auth()->user()->notifications()->limit(10)->get() as $notification)
                        ...
                        <div class="d-flex flex-stack py-4">
                            ...
                            <!--end::Section-->
                            <!--begin::Label-->
                            <span class="badge badge-light fs-8">{{ dateFormat($notification->created_at) }}</span>
                            <!--end::Label-->
                        </div>
                    @endforeach
                    <!--end::Item-->
