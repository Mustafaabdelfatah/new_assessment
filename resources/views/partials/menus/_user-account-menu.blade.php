...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
    ...
    <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
            ...
            {{-- <div class="symbol symbol-50px me-5">
                <img alt="Logo" src="{{ asset('assets') }}/media/avatars/default.webp" />
            </div> --}}
            <!--end::Avatar-->
            <!--begin::Username-->
    ...
    <!--end::Menu separator-->
    <!--begin::Menu item-->
    <div class="menu-item px-5" data-bs-toggle="modal" data-bs-target="#changePasswordModal">
    ...
    <div class="menu-item px-5">
        <a href="{{ url('logout') }}" class="menu-link px-5" id="signOut">
            Sign Out
        </a>
    </div>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.changePassword') }}" method="POST" id="changePasswordForm">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="text-danger" id="current-password"></span>
                    </div>
        ...
        $('#changePasswordForm').submit(function(e) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    ...
                    $('#current-password').text(errors.errors.current_password);
                    $('#error-password').text(errors.errors.new_password);
                    $('#error-password-confirm').text(errors.errors.new_password_confirmation);
                    swal.fire({
                        title: 'Error!',
